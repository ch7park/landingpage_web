...
export function TemplateC({ data, projectId }: TemplateCProps) {
  let pointIndex = 1;
  const getPointLabel = () => `POINT ${pointIndex++}`;

  return (
    <div className="mx-auto min-h-screen w-full max-w-md overflow-hidden bg-white font-sans text-[#1a1a1a]">
